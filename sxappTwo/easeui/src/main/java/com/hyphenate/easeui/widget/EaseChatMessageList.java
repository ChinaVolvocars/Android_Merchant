...
public class EaseChatMessageList extends RelativeLayout {
     ...
     */
    public void init(String toChatUsername, String toChatUserAvatar, int chatType, EaseCustomChatRowProvider customChatRowProvider) {
        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        this.toChatUserAvatar = toChatUserAvatar;

        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername, EaseCommonUtils.getConversationType(chatType), true);
        messageAdapter = new EaseMessageAdapter(context, toChatUsername, toChatUserAvatar, chatType, listView);
	...
	public interface MessageListItemClickListener {
	    ...
	    void onBubbleLongClick(EMMessage message, View v);
