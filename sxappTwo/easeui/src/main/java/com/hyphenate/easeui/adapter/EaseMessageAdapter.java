...
public class EaseMessageAdapter extends BaseAdapter {
	...
	public String getToChatUserAvatar() {
		return StringUtils.nullToStr(toChatUserAvatar);
	}

	public EaseMessageAdapter(Context context, String username, String toChatUserAvatar, int chatType, ListView listView) {
