...
public class StateButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        mNormalTextColor = a.getColor(R.styleable.StateButton_SBnormalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.StateButton_SBpressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.StateButton_SBunableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.StateButton_SBanimationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.StateButton_SBnormalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.StateButton_SBpressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.StateButton_SBunableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.StateButton_SBradius, 0);
        mRound = a.getBoolean(R.styleable.StateButton_SBround, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.StateButton_SBstrokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.StateButton_SBstrokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_SBnormalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_SBpressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_SBunableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.StateButton_SBnormalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.StateButton_SBpressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.StateButton_SBunableStrokeColor, 0);
        setStroke();
