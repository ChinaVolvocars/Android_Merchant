...
public class MPermissionUtils {
    ...
    public static void requestPermissionsLocationResult(Activity activity, int requestCode, OnPermissionListener callback){
        requestPermissions(activity, requestCode, needPermissions, callback);
    }

    public static void requestPermissionsLocationResult(android.support.v4.app.Fragment fragment, int requestCode, OnPermissionListener callback){
        requestPermissions(fragment, requestCode, needPermissions, callback);
    }
