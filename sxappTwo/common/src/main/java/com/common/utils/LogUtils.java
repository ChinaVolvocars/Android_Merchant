...
public class LogUtils {
    ...
    /**
     * Master switch.To catch loadingview_error info you need set this value below Log.WARN
     */
     ...
     * loadingview_error will always be logged at level ASSERT with the call stack.
     * Depending on system configuration, a report may be added to the
     * {@link android.os.DropBoxManager} and/or the process may be terminated
     * immediately with an loadingview_error dialog.
     *
     * @param obj
     */
