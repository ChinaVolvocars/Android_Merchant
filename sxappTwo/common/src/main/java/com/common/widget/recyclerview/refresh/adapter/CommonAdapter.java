...
//    = AnimationType.SLIDE_FROM_BOTTOM
    ...
    private boolean showItemAnimationEveryTime = true;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE.HEADER://header
                baseViewHolder = new ViewHolder(mHeaderLayout, mContext);
                break;
            case VIEW_TYPE.FOOTER://footer
                baseViewHolder = new ViewHolder(mFooterLayout, mContext);
                break;
            default:
                baseViewHolder = createNormalViewHolder(parent, viewType);
                break;
        }
    ...
    public ViewHolder createNormalViewHolder(ViewGroup parent, int viewType) {
        ViewHolder holder = new ViewHolder(mInflater.inflate(layoutIdMap.get(viewType),
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null)
                mChildClickListener.onItemChildClick(CommonAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewCount() - 1);
        }
    }
    ...
    public class OnItemChildLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            if (mChildLongClickListener != null) {
                return mChildLongClickListener.onItemChildLongClick(CommonAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewCount() - 1);
            }
            return false;
        }
    }
    ...
    public interface OnRecyclerViewItemChildLongClickListener {
        boolean onItemChildLongClick(CommonAdapter adapter, View view, int position);
    }
    ...
    protected CommonDialog newCommonDialog(String text, Boolean outSideCancel)
    {
        ...
        dialog.show(((BaseMvpActivity) mContext).getSupportFragmentManager(), "CommonDialog");
        return dialog;
    }
