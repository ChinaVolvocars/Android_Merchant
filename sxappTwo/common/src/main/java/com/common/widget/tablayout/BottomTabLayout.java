...
{
    private static final String KEY_CURRENT_TAG = "com.common.widget.tablayout.BottomTabLayout";

    private Context mContext;
    private ArrayList<CustomTabEntity> mTabEntitys = new ArrayList<>();
    private LinearLayout mTabsContainer;
    private int mCurrentTab;
    private int mRestoreTag;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectColor = ta.getColor(R.styleable.NavBottomTabLayout_nav_textSelectColor, getResources().getColor(R.color.base_color));
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            mRestoreTag = savedInstanceState.getInt(KEY_CURRENT_TAG);
            setCurrentTab(mRestoreTag);
        }
    }

    public void onSaveInstanceState(Bundle outState) {
        outState.putInt(KEY_CURRENT_TAG, mCurrentTab);
    }
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
            tv_tab_title.setTextColor(i == mCurrentTab ? getResources().getColor(R.color.base_color) : getResources().getColor(R.color.base_text_color));
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            tab_title.setTextColor(isSelect ? getResources().getColor(R.color.base_color) : getResources().getColor(R.color.base_text_color));
            ImageView iv_tab_icon = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
            CustomTabEntity tabEntity = mTabEntitys.get(i);
