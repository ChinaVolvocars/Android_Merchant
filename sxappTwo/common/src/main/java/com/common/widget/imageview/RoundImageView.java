package com.common.widget.imageview;
...
public class RoundImageView extends ImageView {
	...
	private int defaultColor = R.color.base_color;
	// 如果只有其中一个有值，则只画一个圆形边框
	private int mBorderOutsideColor = 0;
	private int mBorderInsideColor = R.color.base_color;
	// 控件默认长、宽
	...
	private void setCustomAttributes(AttributeSet attrs) {
		...
		mBorderOutsideColor = a.getColor(R.styleable.roundedimageview_border_outside_color,getResources().getColor(defaultColor));
		mBorderInsideColor = a.getColor(R.styleable.roundedimageview_border_inside_color, getResources().getColor(defaultColor));
	}
