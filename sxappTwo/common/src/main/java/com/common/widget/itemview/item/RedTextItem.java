...
//        arrowViewlp.addRule(RelativeLayout.RIGHT_OF,R.id.red_text_id);
    ...
    public void setRightTextStyle(){
        ...
        redTextViewlp.rightMargin = (int) SizeUtils.dp2px(mContext,marginRight);
        ...
        redTextView.setBackgroundResource(R.drawable.shape_common_item);
        ...
        if(configAttrs.getArrowResId() != 0){
             ...
             arrowViewlp.rightMargin = (int) SizeUtils.dp2px(mContext,configAttrs.getMarginRight());
