...
public class NavigationBar extends RelativeLayout
{
    ...
    /**  设置为二级界面显示  **/
    public void setNavigationType(boolean isSub) {
        if (!isSub) {
//            ivBg.setImageResource(R.mipmap.bg_navigation);
            tvTitle.setTextColor(Color.parseColor("#333333"));
        } else {
            tvTitle.setTextColor(Color.parseColor("#333333"));
//            ivBg.setImageResource(ResourceUtils.getColor(getContext(), R.color.white));
        }
    }
    ...
    public void setBgColorImageView(int color)
    {
     ...
     * @param button 自定义按钮
     */
    final public void setCenterMenu(WidgetButton button)
    {
    ...
    final public void setCenterView(View v)
    {
        ...
        LayoutParams menuLayoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        menuLayoutParams.addRule(RelativeLayout.CENTER_IN_PARENT, RelativeLayout.TRUE);
     ...
     * @return 布局排版规则
     */
    private LayoutParams createLayoutParams(WidgetButton button)
    {
        //判断WidgeButton按钮的类型,图标按钮或是文字按钮
        if (button.getWidgeButtonCategory().equals(WidgetButton.WidgeButtonCategory.image))
        { // 填充图片的按钮
     ...
     * @param button 自定义按钮
     */
    final public void setLeftMenu(WidgetButton button)
    {
        //1.隐藏默认文本容器
     ...
     */
    final public void setLeftMenus(WidgetButton[] buttons)
    {
     ...
     * @param button 自定义按钮
     */
    final public void setRightMenu(WidgetButton button)
    {
        //1.隐藏默认文本容器
     ...
     */
    final public void setRightMenus(WidgetButton[] buttons)
    {
        ...
        for (WidgetButton button : buttons)
        {
            ...
            {
                menuLayoutParams.addRule(RelativeLayout.RIGHT_OF, m_rlRightMenuBar.getChildAt(i - 1).getId());
            }
    ...
    final public void setAppWidgeTitles(String title)
    {
        tvTitle.setCompoundDrawables(null, null, null, null);
        tvTitle.setClickable(false);
        tvTitle.setVisibility(View.VISIBLE);
    ...
    public RelativeLayout getRlCenterMenuBar() {
        return m_rlCenterMenuBar;
    }
}
