...
import com.common.R;
import com.common.widget.recyclerview.refresh.callback.OnItemDragListener;
 ...
 */
public abstract class SuperBaseDragAdapter<T> extends CommonAdapter<T> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled ) {
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                View toggleView = ((ViewHolder) holder).getView(mToggleViewId);
                if (toggleView != null) {
