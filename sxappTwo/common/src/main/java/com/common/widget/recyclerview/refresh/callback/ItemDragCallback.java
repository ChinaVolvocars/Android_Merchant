package com.common.widget.recyclerview.refresh.callback;
...
import com.common.widget.recyclerview.refresh.adapter.SuperBaseDragAdapter;
...
//    private static final String TAG = ItemDragCallback.class.getSimpleName();
    ...
    private boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder) {
        ...
        if (type == CommonAdapter.VIEW_TYPE.HEADER || type == CommonAdapter.VIEW_TYPE.FOOTER) {
            return true;
        }
        return false;
