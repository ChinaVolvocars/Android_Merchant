...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public static final int CURRENT_STATE_PLAYING = 2;//开始图片
    public static final int CURRENT_STATE_PLAYING_BUFFERING_START = 3;
    public static final int CURRENT_STATE_PAUSE = 5;
    public static final int CURRENT_STATE_AUTO_COMPLETE = 6;
    public static final int CURRENT_STATE_ERROR = 7;//错误图片
    ...
    public OnStopListiner mOnStopListiner;
...
//        ((ViewGroup)JCMediaManager.textureView.getParent()).removeView(JCMediaManager.textureView);
     ...
     * 小屏窗口切换为全屏播放
     */
    public void startWindowFullscreens() {
        Log.i(TAG, "startWindowFullscreen " + " [" + this.hashCode() + "] ");
...
//            jcVideoPlayer.setAnimation(ra);
    ...
    public void setStopListener(OnStopListiner onStopListiner) {
        mOnStopListiner = onStopListiner;
    }
    public interface OnStopListiner {
        void onStop();
        void onStart();
    }
}
