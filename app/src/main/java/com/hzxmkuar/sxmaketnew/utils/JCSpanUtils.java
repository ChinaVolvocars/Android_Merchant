...
/**
 * Description: SpannableString处理工具类
 * Author Created by: jc
 * Date Created on: 2017/9/13 14:58
 * Update Update date and time: 2017/9/13 14:58
 * Update Update description:
 * Update Update author: jc
 * Version:
 */
public final class JCSpanUtils {
     ...
     *             </ul>
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight, @Align final int align) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setQuoteColor(@ColorInt final int color, @IntRange(from = 1) final int stripeWidth, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setLeadingMargin(@IntRange(from = 0) final int first, @IntRange(from = 0) final int rest) {
        this.first = first;
        this.rest = rest;
        return this;
    }
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setBullet(@ColorInt final int color, @IntRange(from = 0) final int radius, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setIconMargin(final Bitmap bitmap) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setIconMargin(final Bitmap bitmap, final int gapWidth, @Align final int align) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setIconMargin(final Drawable drawable) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setIconMargin(final Drawable drawable, final int gapWidth, @Align final int align) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setIconMargin(final Uri uri) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setIconMargin(final Uri uri, final int gapWidth, @Align final int align) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setIconMargin(@DrawableRes final int resourceId) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setIconMargin(@DrawableRes final int resourceId, final int gapWidth, @Align final int align) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setFontProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setFontXProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setStrikethrough() {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setUnderline() {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setSuperscript() {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setSubscript() {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius, final Blur style) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final float dx,
                                 final float dy,
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return {@link JCSpanUtils}
     */
    public JCSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
    ...
    private void updateCharCharSequence() {
        ...
        if (iconMarginGapWidth != -1) {
            if (iconMarginBitmap != null) {
                ...
                mBuilder.setSpan(new CustomIconMarginSpan(ContextUtils.getAppContext(), iconMarginUri, iconMarginGapWidth, alignIconMargin), start, end, flag);
            } else if (iconMarginResourceId != -1) {
                mBuilder.setSpan(new CustomIconMarginSpan(ContextUtils.getAppContext(), iconMarginResourceId, iconMarginGapWidth, alignIconMargin), start, end, flag);
            }
        }
    ...
    private void updateImage() {
        ...
        int end = start + 5;
        if (imageBitmap != null) {
            mBuilder.setSpan(new CustomImageSpan(ContextUtils.getAppContext(), imageBitmap, alignImage), start, end, flag);
        } else if (imageDrawable != null) {
            mBuilder.setSpan(new CustomImageSpan(imageDrawable, alignImage), start, end, flag);
        } else if (imageUri != null) {
            mBuilder.setSpan(new CustomImageSpan(ContextUtils.getAppContext(), imageUri, alignImage), start, end, flag);
        } else if (imageResourceId != -1) {
            mBuilder.setSpan(new CustomImageSpan(ContextUtils.getAppContext(), imageResourceId, alignImage), start, end, flag);
        }
    }
