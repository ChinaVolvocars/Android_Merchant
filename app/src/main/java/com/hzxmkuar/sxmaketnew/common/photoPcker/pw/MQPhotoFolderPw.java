package com.hzxmkuar.sxmaketnew.common.photoPcker.pw;
...
import com.hzxmkuar.sxmaketnew.common.photoPcker.ImageFolderModel;
import com.hzxmkuar.sxmaketnew.common.photoPcker.MQImageView;
...
public class MQPhotoFolderPw extends MQBasePopupWindow implements AdapterView.OnItemClickListener {
    ...
    private class FolderAdapter extends BaseAdapter {
        ...
        public FolderAdapter() {
            ...
            mImageWidth = SizeUtils.getScreenWidth(mActivity) / 10;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            MQImage.displayImage(mActivity, folderViewHolder.photoIv, imageFolderModel.coverPath,
                    R.mipmap.mq_ic_holder_light, R.mipmap.mq_ic_holder_light, mImageWidth, mImageHeight, null);
