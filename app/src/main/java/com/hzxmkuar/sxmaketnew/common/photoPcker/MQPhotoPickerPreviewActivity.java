...
import com.hzxmkuar.sxmaketnew.common.photoPcker.imageloader.MQImage;
import com.hzxmkuar.sxmaketnew.common.photoPcker.photoview.PhotoViewAttacher;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.back_iv) {
            ...
            if (mSelectedImages.contains(currentImage)) {
                ...
                mChooseTv.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.mq_ic_cb_normal, 0, 0, 0);
                renderTopRightBtn();
            } else {
                if (mMaxChooseCount == 1) {
                    // 单选
                    ...
                    mChooseTv.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.mq_ic_cb_checked, 0, 0, 0);
                    renderTopRightBtn();
                } else {
                    // 多选
                    if (mMaxChooseCount == mSelectedImages.size()) {
                        ToastManager.showShortToast(getString(R.string.mq_toast_photo_picker_max, mMaxChooseCount + ""));
                    } else {
                        mSelectedImages.add(currentImage);
                        mChooseTv.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.mq_ic_cb_checked, 0, 0, 0);
                        renderTopRightBtn();
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            imageView.setDrawableChangedCallback(new MQImageView.OnDrawableChangedCallback() {
                ...
                public void onDrawableChanged(Drawable drawable) {
                    if (drawable != null && drawable.getIntrinsicHeight() > drawable.getIntrinsicWidth() && drawable.getIntrinsicHeight() > ScreenUtils.getScreenHeight(imageView.getContext())) {
            ...
            MQImage.displayImage(MQPhotoPickerPreviewActivity.this, imageView, mPreviewImages.get(position),
                    R.mipmap.mq_ic_holder_dark, R.mipmap.mq_ic_holder_dark, ScreenUtils.getScreenWidth(MQPhotoPickerPreviewActivity.this), ScreenUtils.getScreenHeight(MQPhotoPickerPreviewActivity.this), null);
