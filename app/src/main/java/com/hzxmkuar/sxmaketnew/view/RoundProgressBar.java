...
public class RoundProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(centre,centre, radius, paint1);
        ...
        if(textIsDisplayable  && style == STROKE){
            canvas.drawBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher),centre-25, centre/2, paint1);
            canvas.drawText(percent + "%", centre - textWidth / 2, centre + textSize*4/5, paint); //画出进度百分比
        }
