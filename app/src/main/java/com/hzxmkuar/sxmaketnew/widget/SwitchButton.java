package com.hzxmkuar.sxmaketnew.widget;
 ...
 * Date Created on: 2018/10/14 10:55
 * Update Update date and time: 2017/8/2 10:55
...
//        colorPrimaryDark = a.getColor(R.styleable.SwitchView_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        colorPrimary = a.getColor(R.styleable.SwitchButton_primaryColor, getResources().getColor(R.color.switch_open_color));
        colorPrimaryDark = a.getColor(R.styleable.SwitchButton_primaryColorDark, getResources().getColor(R.color.switch_close_color));
...
//        paint.setColor(isOn ? colorPrimary : 0xffE3E3E3);
        paint.setColor(isOn ? colorPrimary : getResources().getColor(R.color.switch_close_color));
...
//        paint.setColor(0xFFFFFFFF);
        // 关闭时的背景颜色
        paint.setColor(getResources().getColor(R.color.switch_close_color));
        canvas.drawPath(sPath, paint);
        canvas.restore();
...
//        paint.setColor(isOn ? colorPrimaryDark : 0xFFBFBFBF);
        paint.setColor(isOn ? colorPrimaryDark : getResources().getColor(R.color.switch_close_color));
        canvas.drawPath(bPath, paint);
        canvas.restore();
