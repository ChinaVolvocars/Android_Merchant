...
//        getStatesBar().setBackgroundResource(context.getResources().getColor(R.color.color_00fff));
        // 设置标题栏背景
//        getNavigationBar().setBackgroundResource(R.mipmap.titles_bac);
//        getNavigationBar().getTitleView().setTextColor(context.getResources().getColor(R.color.white));
