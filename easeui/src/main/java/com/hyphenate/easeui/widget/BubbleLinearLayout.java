...
public class BubbleLinearLayout extends ViewGroup {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        orientation = LEFT;
        borderWidth = (int) SizeUtils.dp2px(context, 2);
        radius = (int) SizeUtils.dp2px(context, 5);
        triangleWidth = (int) SizeUtils.dp2px(context, 12);
        triangleHeight = (int) SizeUtils.dp2px(context, 8);
        offset = (int) SizeUtils.dp2px(context, 8);
