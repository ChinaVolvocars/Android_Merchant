...
public class EaseChatRowVoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct() == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(R.drawable.ease_chat_from_voice_play);
		} else {
			voiceIconView.setImageResource(R.drawable.ease_chat_to_voice_play);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
	...
	private void showAnimation() {
		...
		if (message.direct() == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(R.drawable.voice_left);
		} else {
			voiceIconView.setImageResource(R.drawable.voice_right);
		}
