...
public class WidgetButton extends LinearLayout
{
    ...
    public WidgetButton(Context context, AttributeSet attrs)
    {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.WidgetButton,
                R.styleable.WidgeButtonTheme_WidgeButtonStyle, R.style.Widget_WidgeButton);

        m_divider = array.getString(R.styleable.WidgetButton_shanliaodivider);
        ...
        m_nBGResId = array.getResourceId(R.styleable.WidgetButton_src, -1);
    ...
    public WidgetButton(Context context, AttributeSet attrs, ImageView imageView)
    {
        this(context, attrs);
        m_ivBtnBackground = imageView;
    }

    public WidgetButton(Context context, int resId, boolean bool)
    {
        this(context);
    ...
    public WidgetButton(Context context, Drawable drawable, int width, int height)
    {
        this(context);
    ...
    public WidgetButton(Context context, int text)
    {
        this(context);
