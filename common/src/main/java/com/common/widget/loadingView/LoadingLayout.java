...
public class LoadingLayout extends FrameLayout {
    ...
    private static int emptyImgId = R.mipmap.loadingview_empty;
    private static int errorImgId = R.mipmap.loadingview_error;
    private static int networkImgId = R.mipmap.loadingview_no_network;
    ...
    private static int tipTextColor = R.color.base_text_color;
    private static int buttonTextColor = R.color.base_text_color;
    ...
    private void build() {
        ...
        loadingPage.setBackgroundColor(ResourceUtils.getColor(mContext, backgroundColor));
        errorPage.setBackgroundColor(ResourceUtils.getColor(mContext, backgroundColor));
        emptyPage.setBackgroundColor(ResourceUtils.getColor(mContext, backgroundColor));
        networkPage.setBackgroundColor(ResourceUtils.getColor(mContext, backgroundColor));

        errorText = ResourceUtils.findViewById(errorPage, R.id.error_text);
        emptyText = ResourceUtils.findViewById(emptyPage, R.id.empty_text);
        networkText = ResourceUtils.findViewById(networkPage, R.id.no_network_text);

        errorImg = ResourceUtils.findViewById(errorPage, R.id.error_img);
        emptyImg = ResourceUtils.findViewById(emptyPage, R.id.empty_img);
        networkImg = ResourceUtils.findViewById(networkPage, R.id.no_network_img);

        errorReloadBtn = ResourceUtils.findViewById(errorPage, R.id.error_reload_btn);
        networkReloadBtn = ResourceUtils.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        errorText.setTextColor(ResourceUtils.getColor(mContext, tipTextColor));
        emptyText.setTextColor(ResourceUtils.getColor(mContext, tipTextColor));
        networkText.setTextColor(ResourceUtils.getColor(mContext, tipTextColor));
        ...
        errorReloadBtn.setTextColor(ResourceUtils.getColor(mContext, buttonTextColor));
        networkReloadBtn.setTextColor(ResourceUtils.getColor(mContext, buttonTextColor));

        if (buttonHeight != -1) {

            errorReloadBtn.setHeight(ResourceUtils.dp2px(mContext, buttonHeight));
            networkReloadBtn.setHeight(ResourceUtils.dp2px(mContext, buttonHeight));
        }
        if (buttonWidth != -1) {

            errorReloadBtn.setWidth(ResourceUtils.dp2px(mContext, buttonWidth));
            networkReloadBtn.setWidth(ResourceUtils.dp2px(mContext, buttonWidth));
        }
    ...
    public void setStatus(Status status) {
        ...
        switch (status) {
            ...
            case Error:
                ...
                loadingPage.setVisibility(View.GONE);
                emptyPage.setVisibility(View.GONE);
                errorReloadBtn.setVisibility(View.GONE);
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(ResourceUtils.getColor(mContext, id));
        networkReloadBtn.setTextSize(ResourceUtils.getColor(mContext, id));
        return this;
    }
     ...
     */
    public enum Status {
        Success, Empty, Error, No_Network, Loading
    }
