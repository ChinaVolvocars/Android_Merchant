...
public class SearchQuestionView extends LinearLayout {
    ...
    public SearchQuestionView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public SearchQuestionView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        helper = new RecordSQLiteOpenHelper(context, "yyyy_question.db");
