package com.common.widget.recyclerview.refresh.recycleview.swipemenu;
 ...
 */
public class SwipeMenuRecycler extends XRecyclerView {
    ...
    public SwipeMenuRecycler(Context context) {
		this(context, null);
	}

	public SwipeMenuRecycler(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

    public SwipeMenuRecycler(Context context, AttributeSet attrs, int defStyle) {
