...
public class UploadFileRequestBody<T> extends RequestBody {
    ...
    public UploadFileRequestBody(File file, Subscriber<T> fileUploadObserver) {
        this.mRequestBody = RequestBody.create(MediaType.parse("image/png"), file);
        this.fileUploadObserver = (FileUploadObserver<T>) fileUploadObserver;
    }
    ...
    protected final class CountingSink extends ForwardingSink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            ...
            if (fileUploadObserver != null) {
                fileUploadObserver.onProgressChange(null, bytesWritten, contentLength());
            }
