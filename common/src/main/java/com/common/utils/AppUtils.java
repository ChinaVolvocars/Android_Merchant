...
public class AppUtils {
    ...
    public static String getPacketChannelName()
    {
        ...
        return StringUtils.nullToStr(channel);
    }
    ...
    public static String getChannelVersionName() {
        return getPacketChannelName() + "_" + getVersionName();
    }
    ...
    public static boolean isWeixinAvilible() {
        final PackageManager packageManager = ContextUtils.getAppContext().getPackageManager();// 获取packagemanager
    ...
    public static boolean isQQClientAvailable() {
        final PackageManager packageManager = ContextUtils.getAppContext().getPackageManager();
