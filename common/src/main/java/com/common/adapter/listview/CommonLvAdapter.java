...
/**
 * 基类适配器 不是recyclerview  可对最后一个itme 特殊处理
 */
public abstract class CommonLvAdapter<T> extends BaseAdapter {
    ...
    public CommonLvAdapter(Context context, List<T> mDatas, int itemLayoutId) {
    ...
    public CommonLvAdapter(Context context, int itemLayoutId) {
        this.mContext = context;
