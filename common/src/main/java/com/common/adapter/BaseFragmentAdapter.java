...
public class BaseFragmentAdapter extends FragmentPagerAdapter {
    ...
    public BaseFragmentAdapter(FragmentManager fm, List<Fragment> fragmentList, SparseArray<String> mTitles) {
        super(fm);
        this.mTitles = mTitles;
        setFragments(fm,fragmentList,mTitles);
    }
    //刷新fragment
    public void setFragments(FragmentManager fm, List<Fragment> fragments, SparseArray<String> mTitles) {
        this.mTitles = mTitles;
